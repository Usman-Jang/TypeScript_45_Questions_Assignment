...
function showMagicians3(magicians2: string[]) {
  magicians2.forEach((magician) => console.log(magician));
}

function makeGreat2(magicians3: string[]) {
  const greatMagicians2: string[] = [];
...
const magicians3: string[] = ["David Copperfield","Harry Houdini","Penn Jillette","Teller"];
